...
# 2) Добавить товар на склад  -  Просто тупо добавить товар или должна быть возможность изменить его описание, цену, количество и т.д?
...
# 8) Корзина для покупок, в которой может быть много товаров с общей ценой. - Много товаров с общей ценой, имелось ввиду общей суммой товаров? Если с общей ценой, то как это понимать?
